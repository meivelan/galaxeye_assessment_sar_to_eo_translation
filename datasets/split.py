...
print(
    f"Created new dataset structure with train, val, and test splits.\n 
    {len(os.listdir(new_data_root / 's1' / 'train'))} train samples, 
    {len(os.listdir(new_data_root / 's1' / 'val'))} val samples, 
    {len(os.listdir(new_data_root / 's1' / 'test'))} test samples."
)
